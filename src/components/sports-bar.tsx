...
export default function SportsBar() {
  ...
  function renderContent() {
      ...
      return (
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-slate-300">
            Choose a sport above to view Home, Scores, Schedule, Standings, and Teams.
          </p>
          <p className="mt-4 text-sm text-slate-400">
            No default sport selected (ESPN-style entry experience).
          </p>
        </div>
      );
    }
    ...
    if (activeSection === "Schedule" && activeSport === "Volleyball") {
      return renderVolleyballScheduleCards();
    }
